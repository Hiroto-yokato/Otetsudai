...
**お手伝いポイント管理アプリ** — 子どもがお手伝いの実績を記録し、親がお小遣いを承認する家庭内DXアプリ。
...
詳細は `docs/ideas/initial-requirements.md` を参照。

## 技術スタック

- Java 21（LTS）— 環境に Java 25 がインストール済みだが、Spring Boot 3.x は Java 21 を使用
- Spring Boot 3.4.5（4.0.6 は未リリースのため 3.4.5 を使用）
